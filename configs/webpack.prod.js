...
const ExampleWebpackPlugin = require('./plugins/exampleWebpackPlugin');
const FileListWebpackPlugin = require('./plugins/fileListWebpackPlugin');
...
const UploadWebpackPlugin = require('./plugins/uploadWebpackPlugin');
...
module.exports = merge(common, {
	...
	plugins: [
		...
		// new UploadWebpackPlugin({ outputPath: '/dist' })
	]
});
